...
profile_config = ProfileConfig(
    ...
    target_name="impaladw",
    profiles_yml_filepath="/opt/bitnami/airflow/dags/dbt/jaffle_shop/profiles.yml"
)

with DAG(
    dag_id="cosmos-dbt-impala-import-seeds",
